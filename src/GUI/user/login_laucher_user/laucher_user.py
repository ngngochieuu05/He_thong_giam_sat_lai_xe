...
def main(page: ft.Page, go_back_callback=None):
    ...
    # --- PHẦN TÀI NGUYÊN ---
    bg_image_src = r"D:\TestGUI\src\GUI\data\image_user\backround.jpg"
    logo_src = r"D:\TestGUI\src\GUI\data\image_user\Logo-removebg-preview.png"
    ...
    user_card = ft.Container(
        ...
        content=ft.Row([
            ...
            ft.Container(width=10),
            ft.Column([
                ft.Text("Nguyen Ngoc Hieu", size=18, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
                ft.Text("ID : 12345", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK),
